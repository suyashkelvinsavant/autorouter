...
//
// A Windows-Alt-Tab-style picker popped by the global keyboard shortcut
// (`Ctrl+Shift+P`). The Tauri shell emits a `show-switcher` event; this
// component subscribes on mount and toggles open/close. Data comes from
// `/ui/providers` (or Tauri `cmd_providers`), current defaults from
// `/ui/settings`, and recents/favorites from `localStorage`. Enter commits
// via `api.setDefaultProviderModel(...)`; Esc/click-away cancels.
