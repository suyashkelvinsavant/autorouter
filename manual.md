...
git clone https://github.com/suyashkelvinsavant/autorouter.git
cd autorouter
...
| -------------------------- | ----------------------------------------------------------- |
| OpenAI Chat Completions    | `POST http://127.0.0.1:4073/openai/v1/chat/completions`     |
| OpenAI Responses           | `POST http://127.0.0.1:4073/openai/v1/responses`            |
...
```sh
export OPENAI_API_BASE=http://127.0.0.1:4073/openai/v1
...
| POST   | `/openai/v1/chat/completions` (`stream: true`)    | Streaming variant, returns SSE.            |
| POST   | `/openai/v1/responses`                            | OpenAI Responses shape.                    |
| POST   | `/openai/v1/responses` (`stream: true`)           | Streaming variant.                         |
...
```sh
curl -X POST http://127.0.0.1:4073/openai/v1/chat/completions \
