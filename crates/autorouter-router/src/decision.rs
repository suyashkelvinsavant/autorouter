...
pub trait Router: Send + Sync {
    ...
    /// Returns true if this router is a SmartRouter with rule-based
    /// routing. Used by the gateway to decide how to handle the sentinel
    /// model: SmartRouter should resolve it during rule evaluation,
    /// while IdentityRouter relies on the gateway's fallback logic.
