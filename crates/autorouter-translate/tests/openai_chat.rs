...
fn streaming_tool_call_first_delta_without_name_still_starts() {
    ...
    let first = r#"data: {"choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"call_7","function":{"arguments":"{\"q\":"}}]}}]}"#;
    ...
    let second = r#"data: {"choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"function":{"arguments":"\"rust\"}"}}]}}]}"#;
