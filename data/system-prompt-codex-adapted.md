...
**Why this matters:** the tools are the only way you affect the world. Calling exec_command with cat heredoc instead of echoing "please save this file" is the difference between doing the job and pretending to. The user cannot and will not copy-paste for you.
